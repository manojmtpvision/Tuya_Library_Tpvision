...
import org.droidtv.aiot.dev.login.IAccountConfirmView;
import org.droidtv.aiot.dev.login.presenter.AccountConfirmPresenter;
  ...
  //  private EditText mValidateCode;
   // private EditText mETPassword;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences prefs = getSharedPreferences("passwords", MODE_PRIVATE);
         passwords= prefs.getString("pass", "null");
      ...
      // initToolbar();
        ...
        mBtConfirm.setTextColor(getResources().getColor(R.color.black_30));
        initPresenter();
...
//                Log.d("empty","empty");
            ...
            public void onOTPComplete(String otp) {
                ...
                mBtConfirm.setTextColor(getResources().getColor(R.color.black_90));
            }
        });
...
//        mGetValidateCode.performLongClick();
        mGetValidateCode.post(new Runnable(){
            @Override
            public void run() {
                mGetValidateCode.performClick();
            }
        });
