package org.droidtv.aiot.dev.login.presenter;
...
import org.droidtv.aiot.dev.base.utils.MessageUtil;
import org.droidtv.aiot.dev.login.IAccountConfirmView;
import org.droidtv.aiot.dev.login.activity.AccountConfirmActivity;
...
import static org.droidtv.aiot.dev.login.activity.AccountConfirmActivity.MODE_REGISTER;
...
public class AccountConfirmPresenter extends BasePresenter {
    ...
    private String getTip(int tipResId, String showAccount) {
        return "<font color=\"#ffffff\">" + mContext.getString(tipResId) + "</font>"
                + "<br><font color=\"#ffffff\">" + showAccount + "</font>";
    }
